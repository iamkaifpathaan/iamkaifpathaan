...
I design and ship engineering-led products across embedded systems, IoT platforms, and modern web backends. My work is focused on turning prototypes into practical, deployable systems with clean architecture and measurable impact.
...
- Shipping **Pabloch Smart Switch** toward production-grade reliability.
- Scaling **PabloCommerce** architecture for performance and maintainability.
- Advancing embedded-to-cloud workflows for practical deployment.
